...
<class class="welcome">
        <h2>
        <img src="./logos/trust.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> <img src="./logos/trust.webp" alt="Bank" width="75" height="75" style="font-weight: bold;">
        </h2>
    </class>
...
<tr style="color : black;">
        ...
        <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
            <a href="money.php"><button type="button" class="btn btn-primary btn-lg mb-3">Transfer Money</button></a>
        </div>
    </div>
</div>
